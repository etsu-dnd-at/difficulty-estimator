...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Main.Msg","aliases":{"Main.Enemy":{"type":"{ xp : Int, count : Int }","args":[]},"Main.Player":{"type":"{ name : String, level : Int, active : Bool }","args":[]}},"unions":{"Main.Msg":{"tags":{"PlayerInput":["Main.InputMsg Main.Player"],"EnemyInput":["Main.InputMsg Main.Enemy"]},"args":[]},"Main.InputMsg":{"tags":{"Replace":["Int","a"],"Remove":["Int"],"UpdateNext":["a"],"Add":["a"]},"args":["a"]}}},"versions":{"elm":"0.18.0"}});
}
